...
async def home():
    return HTML.replace("__LOGO_DARK__", LOGO_DARK).replace("__LOGO_PLAY__", PLAY_LOGO_DARK).replace("__LOGO_WATERMARK__", LOGO_WATERMARK)
...
<head>
  ...
  <style>
    ...
    .playlink:hover{ transform: translateY(-1px); background:rgba(0,0,0,.30); border-color: rgba(120,255,180,.35); }
    .playlink img{
...
<body class="theme-cyber">
  ...
  <div class="app" id="app" style="display:none;">
    <div class="topbar">
      ...
      <a class="playlink" href="/play/" target="_blank" rel="noopener noreferrer" title="Open HestioPlay (new tab)">
        <img src="__LOGO_PLAY__" alt="HestioPlay"/>
        <span class="ptxt">HestioPlay</span>
      </a>
...
# ----------------- HestioPlay sub-app (mounted at /play/) -----------------
PLAY_APP_CODE = r'''
...
'''
_play_ns: Dict[str, Any] = {}
exec(PLAY_APP_CODE, _play_ns)
PLAY_APP = _play_ns.get('play_app')
if PLAY_APP is not None:
    app.mount('/play', PLAY_APP)
else:
    log.warning('HestioPlay app failed to load (play_app not found).')
